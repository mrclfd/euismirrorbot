...
def _watch(bot: Bot, update, isTar=False):
    ...
    try:
        ...
        msg += f"\n\nExample:\n<code>/{BotCommands.WatchCommand} https://youtu.be/PIVVOV9PCA0 720 |S.O.B Video</code>\n\n"
        msg += "This file will be downloaded in 720p quality and it's name will be <b>S.O.B Video</b>"
